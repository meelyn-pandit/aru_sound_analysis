...
cbma_water_table2 = function(pc1_contrast_table,
  ...
  cbma_tables_combined2 = cbma_tables_combined[c(1:8,10),] %>%
    gt(.) %>%
    cols_align('center') %>%
    tab_spanner(
  ...
  return(cbma_tables_combined2)
}

cbma_water_table3 = function(pc1_contrast_table,
                             pc2_contrast_table,
                             pc3_contrast_table) {
...
cbma_water_site_paper = function(data,
                                  yvar,
                                  xvar,
                                  ylabel,
                                  xlabel){
