...
ABMout <- apply(terr_freq_ewl_site, MARGIN = 1, function(x){
  aridityABM(HexSize=x[1], #territory size in m, original territory size is 1000m
           ...
           wdata = wfull, # weather data for lwma, sswma, cbma, and kiowa
...
save(ABMout_final, file = "current_ewl.Rdata") #change file name based on which weather conditons you use and if you the EWL equation is included or not.
