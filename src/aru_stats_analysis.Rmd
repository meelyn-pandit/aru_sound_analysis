...
aw4$pc1 = audio_pcadf2$PC1
aw4$pc2 = audio_pcadf2$PC2
...
assump(m1)
Anova(m1)
pairs(emmeans(m1, ~site|mean_aridwithin, data = aw4)) #across site comparisions
pairs(emmeans(m1, ~mean_aridwithin|site, data = aw4)) # within site comparisons
