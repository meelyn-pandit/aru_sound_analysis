...
knitr::opts_chunk$set(echo = TRUE,
                      root.dir = "/home/meelyn/Documents/dissertation/aru_sound_analysis/")
...
## Combine the broad acoustic metrics with BirdNET data (with NAs!!!)

```{r }
knitr::opts_chunk$set(root.dir = "/home/meelyn/Documents/dissertation/aru_sound_analysis/data_clean")
...
acoustic2 = full_join(acoustic, arid_full, by = c("site", "aru", "date_time")) %>%
  rename(local_time = "local_time.y") %>%
...
``` {r }
knitr::opts_chunk$set(echo = TRUE,
                      root.dor = "/home/meelyn/Documents/dissertation/aru_sound_analysis/data_clean")
...
for(s in sites){
  ...
  if(s == "lwma"){
    ...
    hd = lwma_wh %>%
      ...
      rename(gh_hist = "gh_hobs", hist_within = "ghhobs_scaled", hist_across = "ghsite_scaled") %>%
...
aw2$arid_within = cut(aw2$arid_within, breaks = 5, labels = c(1,2,3,4,5)) # observed aridity scaled within sites
...
## Water Supplementation Data Organization
``` {r}
